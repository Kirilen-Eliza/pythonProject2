...
def test_get_mask_card_number(card_number: int, disguised_number: str) -> None:
...
def test_get_mask_card_number_wrong_value() -> None:
...
def test_get_mask_account_wrong_value() -> None:
    """Функция-тест, проверяет функцию на корректность обработки ошибки,
