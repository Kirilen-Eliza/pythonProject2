...
@pytest.fixture
def transaction_expected() -> List[str]:
    return [
        "Перевод организации",
...
def test_card_number_generator_valid(expected_card: List[str]) -> None:
    """
...
def test_card_number_generator_invalid_parameter() -> None:
    """
